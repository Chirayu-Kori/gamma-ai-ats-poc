...
export function RichTextField({
  ...
  const baseEditorClass =
    mode === "inline"
      ? "outline-none focus:outline-none transition-colors hover:ring-2 hover:ring-primary/20 rounded p-1 -m-1 whitespace-pre-wrap break-words [&_.is-editor-empty:first-child::before]:text-muted-foreground [&_.is-editor-empty:first-child::before]:content-[attr(data-placeholder)] [&_.is-editor-empty:first-child::before]:float-left [&_.is-editor-empty:first-child::before]:h-0 [&_.is-editor-empty:first-child::before]:pointer-events-none"
      : "outline-none focus:outline-none transition-colors hover:ring-2 hover:ring-primary/20 rounded p-1.5 -mx-1.5 [&_ul]:!list-disc [&_ul]:list-outside [&_ul]:ml-6 [&_ul]:space-y-1 [&_ol]:!list-decimal [&_ol]:list-outside [&_ol]:ml-6 [&_ol]:space-y-1 [&_p]:m-0 [&_.is-editor-empty:first-child::before]:text-muted-foreground [&_.is-editor-empty:first-child::before]:content-[attr(data-placeholder)] [&_.is-editor-empty:first-child::before]:float-left [&_.is-editor-empty:first-child::before]:h-0 [&_.is-editor-empty:first-child::before]:pointer-events-none";
  ...
  return (
    <div
      className={cn(
        mode === "inline" ? "inline-block w-full" : "w-full",
        className,
      )}
    >
