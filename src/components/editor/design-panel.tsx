...
import { TEMPLATES, type TemplateLayout } from "@/components/templates/registry";
    ...
    <div className="flex items-center justify-between gap-3 rounded-lg border border-slate-200 bg-white px-3 py-2">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-20 rounded border border-slate-200 px-1.5 py-0.5 text-xs font-mono text-slate-700"
        />
        <input
          type="color"
          value={value}
